...
class TestDistro(BaseTest):
	...
	def testGlob(self):
		...
		master_feed = parse_impls("""<package-implementation package='python-bittorrent'><command glob='/etc/hostname' name='run'/></package-implementation>""")
		...
		self.assertEqual('/etc/hostname', impl.main)
